...
function SortHeader({
  ...
  return (
    <th
      className="cursor-pointer select-none whitespace-nowrap pb-2 pr-4 text-left text-xs font-semibold uppercase tracking-wide text-gray-400 hover:text-gray-600"
      onClick={() => onSort(col)}
    >
      {label}
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden">
      ...
      <div className="flex shrink-0 items-center justify-between border-b border-gray-200 bg-white px-6 py-3">
        <h1 className="text-base font-semibold text-gray-900">Equipment Library</h1>
      ...
      {deleteError && (
        <div className="shrink-0 bg-amber-50 px-6 py-2 text-sm text-amber-700">
          {deleteError}
      ...
      {/* Filters */}
      <div className="flex shrink-0 items-center gap-3 border-b border-gray-100 bg-white px-6 py-2">
        <Input
          value={search}
            ...
            <tbody>
              {displayed.map((item) => (
                <tr key={item.id} className="border-b last:border-0 hover:bg-gray-50">
                  ...
                  <td className="py-2 pr-4 capitalize text-gray-600">{item.geometry_type}</td>
                  <td className="py-2 pr-4 text-gray-600">{item.length_m}</td>
                  <td className="py-2 pr-4 text-gray-600">{item.width_m}</td>
                  <td className="py-2 pr-4 text-gray-600">{item.height_m}</td>
                  <td className="py-2 pr-4 text-gray-600">{item.dry_weight_t}</td>
                  <td className="py-2">
